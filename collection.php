    ...
    <div class="page">
        ...
        <div class="toolbar">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
                ...
                <select name="filter_field" class="dropdown">
                ...
                <input type="text" name="filter_value" class="input" placeholder="Search">
                <button type="submit" class="btnFilter">Filter & Sort</button>
            </form>
